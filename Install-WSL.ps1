...
Reference: https://spr.com/two-steps-and-one-script-to-run-linux-on-windows-via-wsl/
WSL manual download: https://docs.microsoft.com/en-us/windows/wsl/install-manual
#>
[CmdletBinding()]
param(
